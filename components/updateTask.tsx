    ...
    <div className="flex gap-2">
      {isEditing ? (
        <>
          <button 
            onClick={onSave}
            className="p-2 text-green-500 hover:bg-green-500/10 rounded-lg transition-colors border border-transparent hover:border-green-500/30"
            title="Save Changes"
          >
          ...
          <button 
            onClick={onCancel}
            className="p-2 text-gray-400 hover:bg-white/10 rounded-lg transition-colors border border-transparent hover:border-gray-800"
            title="Cancel"
          >
            <X className="w-5 h-5" />
          </button>
